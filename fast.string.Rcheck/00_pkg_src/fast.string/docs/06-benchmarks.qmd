...
# Bit-parallel Levenshtein/Damerau-Levenshtein should agree exactly with
# stringdist's reference implementations.
...
fast.string::damerau_levenshtein(c("ab"), c("ba"))
if (has_stringdist) stringdist::stringdist(c("ab"), c("ba"), method = "dl")
```

...
.fast.string_functions <- list(
    ...
    fcount              = "count non-overlapping fixed or regex matches",
    ...
    "fas.POSIXct"       = "fast fixed-format UTC/offset timestamp parsing",
    format_datetime     = "format UTC/fixed-offset timestamps",
    ...
    refined_soundex     = "Refined Soundex phonetic code",
    cologne             = "Cologne German phonetic code",
    ...
    cosine_similarity   = "pairwise q-gram cosine similarity",
